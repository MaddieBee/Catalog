...
celloItem4 = CelloItem(model="Giani 370", description="Finely crafted and varnished by hand.", price="$14,560.00", year="1966", 
...
celloItem1 = CelloItem(model="C1470", description="Finely crafted and varnished by hand.",	price="$13,560.00",
...
celloItem3 = CelloItem(model="Guarneri", description="Warm sound, loud resonance.", price="$8,400.00", year="2003",
...
celloItem5 = CelloItem(model="C970", description="Finely crafted and varnished by hand.", price="$12,360.00",
...
celloItem1 = CelloItem(model="Calin Wultur #7", description="European tonewoods.", price="$7,500.00", year="2017",
...
celloItem5 = CelloItem(model="Guarneri 330", description="Warm sound, loud resonance.", price="$28,400.00", year="1902",
...
celloItem1 = CelloItem(model="L470", description="Finely crafted and varnished by hand.", price="$13,560.00", year="1947",
...
celloItem3 = CelloItem(model="Guarneri X3", description="Warm sound, loud resonance.", price="$11,500.00", year="2013",
...
celloItem5 = CelloItem(model="M70", description="Finely crafted and varnished by hand.", price="$11,360.00", year="1994",
						country="Italy", classification="Advanced",	luthier=luthier4)

session.add(celloItem5)
session.commit()

celloItem6 = CelloItem(model="Regarri 520", description="Hand crafted, warm sound and even resonabce.",	price="$6,250.00",
...
celloItem3 = CelloItem(model="Guarneri X3", description="Warm sound, loud resonance.", price="$17,500.00",
...
celloItem5 = CelloItem(model="Strad 330", description="Finely crafted and varnished by hand.", price="$28,560.00",
